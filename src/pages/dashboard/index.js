...
export default function Dashboard() {
  ...
  //console.log(useFetch(endPoints.products.getProducts(0, 0)));
  return (
    <>
      ...
      <div className="flex flex-col">
        ...
        <Pagination offset={offset} setOffset={setOffset} totalProducts={totalProducts} currentPage={currentPage} setCurrentPage={setCurrentPage} />
      </div>
    </>
  );
}
